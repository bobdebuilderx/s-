...
Tab1:Button("Lock(q)",function(bool)
    loadstring(game:HttpGet("https://pastebin.com/raw/STVHv8es"))()
end)
...
local Tab3 = Window:Tab("discord",true)
Tab3:Textbox("Put in ur discord name)","Name#tag")

local Tab4 = Window:Tab("tp",true)
Tab4:Button("Circus Mountain", function()
...
Tab4:Button("Bank Tree", function()
...
local Tab5 = Window:Tab("Close",false)

Tab5:Label("lol")

Tab5:Keybind("Toggle",Enum.KeyCode.V,function()
    Library:Toggle()
end)
